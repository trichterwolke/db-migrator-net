...
namespace NeosIT.DBMigrator.DBMigration.Options.MSSQL
{
    public class Options : DefaultOptions
    {
        [Option("u", "username", HelpText = "A valid username for Microsoft SQL server. If none is set, a trusted connection (sqlcmd parameter -E) is used. If you specify a username, you need to add a password!")]
